...
personajes_en :: [Either Personaje Objeto] -> [Objeto]
personajes_en = ?

{-Ejercicio 4-}

objetos_en_posesión_de :: String -> [Either Objeto Personaje] -> [Objeto] 
objetos_en_posesión_de = ?

{-Ejercicio 5-}

-- Asume que hay al menos un objeto
objeto_libre_mas_cercano :: Personaje -> [Either Objeto Personaje] -> [Objeto]
objeto_libre_mas_cercano = ?

{-Ejercicio 6-}

tiene_thanos_todas_las_gemas :: [Either Objeto Personaje] -> Bool
